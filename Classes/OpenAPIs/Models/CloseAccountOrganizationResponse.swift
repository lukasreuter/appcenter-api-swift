//
// CloseAccountOrganizationResponse.swift
//
...
public struct CloseAccountOrganizationResponse: Codable {
    ...
    public init(id: UUID, displayName: String, name: String, avatarUrl: String?, origin: Origin, createdAt: String, updatedAt: String, collaboratorsCount: Double?) {
        self.id = id
