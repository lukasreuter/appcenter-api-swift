//
// NotificationDetailsResult.swift
//
...
public struct NotificationDetailsResult: Codable {
    ...
    public var notificationContent: Any?
    /** Failture outcome counts */
    public var failureOutcomes: [Any]?
    /** Notification name */
    ...
    public init(notificationId: String, state: StatenotificationContent: Any?, failureOutcomes: [Any]?name: String?, notificationTarget: InlineResponse20035NotificationTarget?, sendTime: Date?, pnsSendFailure: Int?, pnsSendSuccess: Int?, ) {
