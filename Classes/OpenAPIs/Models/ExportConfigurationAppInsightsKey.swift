//
// ExportConfigurationAppInsightsKey.swift
//
...
public struct ExportConfigurationAppInsightsKey: Codable {
    ...
    public init(type: ModelType, instrumentationKey: String?exportEntities: [ExportEntities]?, resourceName: String?, resourceGroup: String?, backfill: Bool?) {
        self.type = type
