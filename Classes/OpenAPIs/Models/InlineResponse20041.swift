...
public struct InlineResponse20041: Codable {
    ...
    /** the list of logs */
    public var logs: [InlineResponse20041Logs]

    public init(exceededMaxLimit: Bool?, lastReceivedLogTimestamp: Date?, logs: [InlineResponse20041Logs]) {
