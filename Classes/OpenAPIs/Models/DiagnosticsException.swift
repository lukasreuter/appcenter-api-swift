...
public struct DiagnosticsException: Codable {
    ...
    public init(reason: String?, type: String?, frames: [ExceptionFrames], relevant: Bool?, innerExceptions: [DiagnosticsException]?, platform: Platform?) {
        self.reason = reason
        self.type = type
        self.frames = frames
