//
// ExportConfigurationBlobStorageLinkedSubscription.swift
//
...
public struct ExportConfigurationBlobStorageLinkedSubscription: Codable {
    ...
    public init(subscriptionId: String?, type: ModelType, exportEntities: [ExportEntities]?, resourceName: String?, resourceGroup: String?, backfill: Bool?) {
