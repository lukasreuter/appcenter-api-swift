//
// ExportConfigurationAppInsightsLinkedSubscription.swift
//
...
public struct ExportConfigurationAppInsightsLinkedSubscription: Codable {
    ...
    public init(type: ModelType, subscriptionId: String?exportEntities: [ExportEntities]?, resourceName: String?, resourceGroup: String?, backfill: Bool?) {
        self.type = type
