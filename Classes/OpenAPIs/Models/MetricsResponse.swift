...
public struct MetricsResponse: Codable {
    ...
    public var metrics: MetricsResponseMetrics?

    public init(databaseLocation: DatabaseLocation?, accountName: String?, databaseId: String?, metrics: MetricsResponseMetrics?) {
